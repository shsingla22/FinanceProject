...
| `tests/test_skill.py` | 16 tests: completeness, synthetic profiles shaped like the document's examples, severity ladder, explainability contract, report jargon scan, real-data integration |
