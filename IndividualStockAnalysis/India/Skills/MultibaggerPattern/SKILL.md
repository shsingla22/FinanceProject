...
| `scripts/analyze.py` | CLI: `screen` the universe · `company SYM [--ai]` · `report SYM out.md [--ai]`; the `--ai` judge reads the concall timeline + management history via headless Claude (Opus, no timeout, cached per transcript) |
