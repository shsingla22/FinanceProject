# Lloyds Engr Works (LLOYDSENGG) — Stock vs Nifty 50: price and earnings ratios
...
**Verdict: GAINED on the index: the ratio rose +66% from FY2025 to FY2026.**

```
FY2025  ████████████████           0.013%
FY2026  ██████████████████████████ 0.022%  ▲ +65.7% vs prior year
```
...
**Verdict: GAINED on the index: the ratio rose +38% from FY2025 to FY2026.**

```
FY2025  ███████████████████        0.013%
FY2026  ██████████████████████████ 0.017%  ▲ +37.9% vs prior year
```
...
The same graph in two other formats sits beside this file: [`LLOYDSENGG_stock_to_index.svg`](LLOYDSENGG_stock_to_index.svg) — a vector chart that opens in any browser — and [`LLOYDSENGG_stock_to_index.mmd`](LLOYDSENGG_stock_to_index.mmd) — Mermaid source, which draws itself when pasted into GitHub.
...
| FY2025 | — | — | 105 | 796,066 | 135 | 1,068,504 |
| FY2026 | — | — | 198 | 905,734 | 189 | 1,084,854 |
