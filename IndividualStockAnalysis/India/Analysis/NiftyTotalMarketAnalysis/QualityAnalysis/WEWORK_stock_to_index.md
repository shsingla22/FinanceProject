# Wework India Managem (WEWORK) — Stock vs Nifty 50: price and earnings ratios
...
```
FY2023  ▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ -0.026%
FY2024  ▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒        -0.019%  ▲ +26.3% vs prior year
FY2025  ████████████████           0.016%  ▲ +185.3% vs prior year
FY2026  ████████                   0.008%  ▼ -48.5% vs prior year
```
...
**Verdict: GAINED on the index: the ratio rose +62% from FY2023 to FY2026.**

```
FY2023  ████████████████           0.089%
FY2024  ███████████████████        0.104%  ▲ +16.1% vs prior year
FY2025  █████████████████████      0.116%  ▲ +11.7% vs prior year
FY2026  ██████████████████████████ 0.145%  ▲ +25.1% vs prior year
```
...
The same graph in two other formats sits beside this file: [`WEWORK_stock_to_index.svg`](WEWORK_stock_to_index.svg) — a vector chart that opens in any browser — and [`WEWORK_stock_to_index.mmd`](WEWORK_stock_to_index.mmd) — Mermaid source, which draws itself when pasted into GitHub.
...
| FY2023 | — | — | -147 | 574,328 | 796 | 890,079 |
| FY2024 | — | — | -136 | 721,343 | 1,047 | 1,008,599 |
| FY2025 | — | — | 128 | 796,066 | 1,239 | 1,068,504 |
| FY2026 | — | — | 75 | 905,734 | 1,574 | 1,084,854 |
