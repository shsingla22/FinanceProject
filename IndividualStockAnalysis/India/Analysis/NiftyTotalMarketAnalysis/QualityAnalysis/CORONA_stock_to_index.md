# CORONA Remedies (CORONA) — Stock vs Nifty 50: price and earnings ratios
...
**Verdict: GAINED on the index: the ratio rose +38% from FY2023 to FY2026.**

```
FY2023  ███████████████████        0.015%
FY2024  ████████████████           0.012%  ▼ -15.7% vs prior year
FY2025  ████████████████████████   0.019%  ▲ +50.0% vs prior year
FY2026  ██████████████████████████ 0.020%  ▲ +9.1% vs prior year
```
...
**Verdict: GAINED on the index: the ratio rose +88% from FY2023 to FY2026.**

```
FY2023  ██████████████             0.014%
FY2024  ███████████████            0.015%  ▲ +7.6% vs prior year
FY2025  ██████████████████████     0.023%  ▲ +45.8% vs prior year
FY2026  ██████████████████████████ 0.027%  ▲ +20.2% vs prior year
```
...
The same graph in two other formats sits beside this file: [`CORONA_stock_to_index.svg`](CORONA_stock_to_index.svg) — a vector chart that opens in any browser — and [`CORONA_stock_to_index.mmd`](CORONA_stock_to_index.mmd) — Mermaid source, which draws itself when pasted into GitHub.
...
| FY2023 | — | — | 85 | 574,328 | 128 | 890,079 |
| FY2024 | — | — | 90 | 721,343 | 156 | 1,008,599 |
| FY2025 | — | — | 149 | 796,066 | 241 | 1,068,504 |
| FY2026 | — | — | 185 | 905,734 | 294 | 1,084,854 |
