# Manorama Inds (MANORAMA) — Stock vs Nifty 50: price and earnings ratios
...
**Verdict: GAINED on the index: the ratio rose +80% from FY2025 to FY2026.**

```
FY2025  ██████████████             0.014%
FY2026  ██████████████████████████ 0.025%  ▲ +79.8% vs prior year
```
...
| last 1 year | FY2025 | FY2026 | +80% |


## 3. Operating-profit ratio — company operating profit ÷ index operating profit (% of index)

**Verdict: GAINED on the index: the ratio rose +91% from FY2025 to FY2026.**

```
FY2025  ██████████████             0.017%
FY2026  ██████████████████████████ 0.033%  ▲ +91.2% vs prior year
```
...
The same graph in two other formats sits beside this file: [`MANORAMA_stock_to_index.svg`](MANORAMA_stock_to_index.svg) — a vector chart that opens in any browser — and [`MANORAMA_stock_to_index.mmd`](MANORAMA_stock_to_index.mmd) — Mermaid source, which draws itself when pasted into GitHub.
...
| FY2025 | — | — | 110 | 796,066 | 186 | 1,068,504 |
| FY2026 | — | — | 225 | 905,734 | 361 | 1,084,854 |
