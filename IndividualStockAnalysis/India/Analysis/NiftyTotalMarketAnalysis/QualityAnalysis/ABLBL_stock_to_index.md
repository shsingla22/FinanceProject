# A B Lifestyle (ABLBL) — Stock vs Nifty 50: price and earnings ratios
...
**Verdict: GAINED on the index: the ratio rose +150% from FY2025 to FY2026.**

```
FY2025  ██████████                 0.008%
FY2026  ██████████████████████████ 0.019%  ▲ +150.5% vs prior year
```
...
| last 1 year | FY2025 | FY2026 | +150% |


## 3. Operating-profit ratio — company operating profit ÷ index operating profit (% of index)

**Verdict: GAINED on the index: the ratio rose +10% from FY2025 to FY2026.**

```
FY2025  ████████████████████████   0.114%
FY2026  ██████████████████████████ 0.126%  ▲ +10.4% vs prior year
```
...
The same graph in two other formats sits beside this file: [`ABLBL_stock_to_index.svg`](ABLBL_stock_to_index.svg) — a vector chart that opens in any browser — and [`ABLBL_stock_to_index.mmd`](ABLBL_stock_to_index.mmd) — Mermaid source, which draws itself when pasted into GitHub.
...
| FY2025 | — | — | 60 | 796,066 | 1,223 | 1,068,504 |
| FY2026 | 88.23 | 23,997.55 | 171 | 905,734 | 1,371 | 1,084,854 |
