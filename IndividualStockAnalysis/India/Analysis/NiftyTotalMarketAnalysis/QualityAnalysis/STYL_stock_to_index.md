# Seshaasai Technologi (STYL) — Stock vs Nifty 50: price and earnings ratios
...
**Verdict: GAINED on the index: the ratio rose +13% from FY2024 to FY2026.**

```
FY2024  ██████████████████████     0.023%
FY2025  ██████████████████████████ 0.028%  ▲ +19.0% vs prior year
FY2026  █████████████████████████  0.026%  ▼ -5.0% vs prior year
```
...
**Verdict: GAINED on the index: the ratio rose +21% from FY2024 to FY2026.**

```
FY2024  █████████████████████      0.029%
FY2025  █████████████████████████  0.034%  ▲ +16.7% vs prior year
FY2026  ██████████████████████████ 0.035%  ▲ +3.7% vs prior year
```
...
The same graph in two other formats sits beside this file: [`STYL_stock_to_index.svg`](STYL_stock_to_index.svg) — a vector chart that opens in any browser — and [`STYL_stock_to_index.mmd`](STYL_stock_to_index.mmd) — Mermaid source, which draws itself when pasted into GitHub.
...
| FY2024 | — | — | 169 | 721,343 | 292 | 1,008,599 |
| FY2025 | — | — | 222 | 796,066 | 361 | 1,068,504 |
| FY2026 | — | — | 240 | 905,734 | 380 | 1,084,854 |
