# Styrenix Performance (STYRENIX) — Stock vs Nifty 50: price and earnings ratios
...
**Verdict: GAINED on the index: the ratio rose +885% from FY2024 to FY2026.**

```
FY2024  ███                        0.003%
FY2025  ██████████████████████     0.022%  ▲ +725.1% vs prior year
FY2026  ██████████████████████████ 0.026%  ▲ +19.4% vs prior year
```
...
**Verdict: GAINED on the index: the ratio rose +281% from FY2024 to FY2026.**

```
FY2024  ███████                    0.009%
FY2025  ████████████████████       0.025%  ▲ +189.8% vs prior year
FY2026  ██████████████████████████ 0.032%  ▲ +31.3% vs prior year
```
...
The same graph in two other formats sits beside this file: [`STYRENIX_stock_to_index.svg`](STYRENIX_stock_to_index.svg) — a vector chart that opens in any browser — and [`STYRENIX_stock_to_index.mmd`](STYRENIX_stock_to_index.mmd) — Mermaid source, which draws itself when pasted into GitHub.
...
| FY2024 | — | — | 19 | 721,343 | 86 | 1,008,599 |
| FY2025 | — | — | 173 | 796,066 | 264 | 1,068,504 |
| FY2026 | — | — | 235 | 905,734 | 352 | 1,084,854 |
