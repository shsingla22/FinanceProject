...
The same graph in two other formats sits beside this file: [`THELEELA_stock_to_index.svg`](THELEELA_stock_to_index.svg) — a vector chart that opens in any browser — and [`THELEELA_stock_to_index.mmd`](THELEELA_stock_to_index.mmd) — Mermaid source, which draws itself when pasted into GitHub.
