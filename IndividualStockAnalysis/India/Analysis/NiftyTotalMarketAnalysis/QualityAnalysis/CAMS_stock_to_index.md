...
The same graph in two other formats sits beside this file: [`CAMS_stock_to_index.svg`](CAMS_stock_to_index.svg) — a vector chart that opens in any browser — and [`CAMS_stock_to_index.mmd`](CAMS_stock_to_index.mmd) — Mermaid source, which draws itself when pasted into GitHub.
