# Siemens Ener.Ind (ENRIN) — Stock vs Nifty 50: price and earnings ratios
...
The same graph in two other formats sits beside this file: [`ENRIN_stock_to_index.svg`](ENRIN_stock_to_index.svg) — a vector chart that opens in any browser — and [`ENRIN_stock_to_index.mmd`](ENRIN_stock_to_index.mmd) — Mermaid source, which draws itself when pasted into GitHub.
...
| FY2026 | 2,565.50 | 23,997.55 | -0 | 905,734 | -0 | 1,084,854 |
