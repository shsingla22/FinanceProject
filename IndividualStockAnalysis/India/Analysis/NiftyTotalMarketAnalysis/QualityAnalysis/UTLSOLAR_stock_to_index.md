# Fujiyama Power Syste (UTLSOLAR) — Stock vs Nifty 50: price and earnings ratios
...
**Verdict: GAINED on the index: the ratio rose +51% from FY2020 to FY2021.**

```
FY2020  █████████████████          0.004%
FY2021  ██████████████████████████ 0.006%  ▲ +51.2% vs prior year
```
...
|---|---|---|---|
| last 15 years | FY2006 | FY2021 | n/a — data starts FY2020 |
| last 10 years | FY2011 | FY2021 | n/a — data starts FY2020 |
| last 5 years | FY2016 | FY2021 | n/a — data starts FY2020 |
| last 3 years | FY2018 | FY2021 | n/a — data starts FY2020 |
| last 1 year | FY2020 | FY2021 | +51% |


## 3. Operating-profit ratio — company operating profit ÷ index operating profit (% of index)

**Verdict: GAINED on the index: the ratio rose +23% from FY2020 to FY2021.**

```
FY2020  █████████████████████      0.006%
FY2021  ██████████████████████████ 0.007%  ▲ +22.9% vs prior year
```
...
The same graph in two other formats sits beside this file: [`UTLSOLAR_stock_to_index.svg`](UTLSOLAR_stock_to_index.svg) — a vector chart that opens in any browser — and [`UTLSOLAR_stock_to_index.mmd`](UTLSOLAR_stock_to_index.mmd) — Mermaid source, which draws itself when pasted into GitHub.
...
| FY2020 | — | — | 11 | 275,997 | 28 | 491,207 |
| FY2021 | — | — | 20 | 331,853 | 38 | 542,357 |
