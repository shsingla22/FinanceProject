# Sanofi Cons. Health (SANOFICONR) — Stock vs Nifty 50: price and earnings ratios
...
**Verdict: GAINED on the index: the ratio rose +17% from FY2025 to FY2026.**

```
FY2025  ██████████████████████     0.023%
FY2026  ██████████████████████████ 0.026%  ▲ +16.5% vs prior year
```
...
**Verdict: GAINED on the index: the ratio rose +12% from FY2025 to FY2026.**

```
FY2025  ███████████████████████    0.025%
FY2026  ██████████████████████████ 0.028%  ▲ +12.3% vs prior year
```
...
The same graph in two other formats sits beside this file: [`SANOFICONR_stock_to_index.svg`](SANOFICONR_stock_to_index.svg) — a vector chart that opens in any browser — and [`SANOFICONR_stock_to_index.mmd`](SANOFICONR_stock_to_index.mmd) — Mermaid source, which draws itself when pasted into GitHub.
...
| FY2025 | — | — | 181 | 796,066 | 271 | 1,068,504 |
| FY2026 | — | — | 240 | 905,734 | 309 | 1,084,854 |
