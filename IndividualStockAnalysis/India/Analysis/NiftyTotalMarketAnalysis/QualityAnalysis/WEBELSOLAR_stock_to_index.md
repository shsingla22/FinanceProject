# Websol Energy System (WEBELSOLAR) — Stock vs Nifty 50: price and earnings ratios
...
**Verdict: GAINED on the index: the ratio rose +72% from FY2025 to FY2026.**

```
FY2025  ███████████████            0.019%
FY2026  ██████████████████████████ 0.033%  ▲ +71.8% vs prior year
```
...
| last 1 year | FY2025 | FY2026 | +72% |


## 3. Operating-profit ratio — company operating profit ÷ index operating profit (% of index)

**Verdict: GAINED on the index: the ratio rose +67% from FY2025 to FY2026.**

```
FY2025  ████████████████           0.024%
FY2026  ██████████████████████████ 0.040%  ▲ +67.0% vs prior year
```
...
The same graph in two other formats sits beside this file: [`WEBELSOLAR_stock_to_index.svg`](WEBELSOLAR_stock_to_index.svg) — a vector chart that opens in any browser — and [`WEBELSOLAR_stock_to_index.mmd`](WEBELSOLAR_stock_to_index.mmd) — Mermaid source, which draws itself when pasted into GitHub.
...
| FY2025 | — | — | 155 | 796,066 | 253 | 1,068,504 |
| FY2026 | — | — | 303 | 905,734 | 429 | 1,084,854 |
