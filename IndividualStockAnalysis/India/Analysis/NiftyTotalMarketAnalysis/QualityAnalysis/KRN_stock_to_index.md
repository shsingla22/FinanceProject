# KRN Heat Exch Refrig (KRN) — Stock vs Nifty 50: price and earnings ratios
...
**Verdict: GAINED on the index: the ratio rose +55% from FY2024 to FY2026.**

```
FY2024  █████████████████          0.005%
FY2025  █████████████████████      0.007%  ▲ +23.1% vs prior year
FY2026  ██████████████████████████ 0.008%  ▲ +26.0% vs prior year
```
...
**Verdict: GAINED on the index: the ratio rose +76% from FY2024 to FY2026.**

```
FY2024  ███████████████            0.006%
FY2025  ████████████████           0.007%  ▲ +12.0% vs prior year
FY2026  ██████████████████████████ 0.010%  ▲ +57.6% vs prior year
```
...
The same graph in two other formats sits beside this file: [`KRN_stock_to_index.svg`](KRN_stock_to_index.svg) — a vector chart that opens in any browser — and [`KRN_stock_to_index.mmd`](KRN_stock_to_index.mmd) — Mermaid source, which draws itself when pasted into GitHub.
...
| FY2024 | — | — | 39 | 721,343 | 59 | 1,008,599 |
| FY2025 | — | — | 53 | 796,066 | 70 | 1,068,504 |
| FY2026 | — | — | 76 | 905,734 | 112 | 1,084,854 |
